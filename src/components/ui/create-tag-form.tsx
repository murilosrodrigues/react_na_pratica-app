    ...
    return(
       <form onSubmit={handleSubmit(createTag)} className="w-full space-y-6">
        <div className="space-y-2">
            ...
            <input {...register('title')} id="title" type="text" className="border border-zinc-800 rounded-lg px-3 py-2.5 bg-zinc-800/50 w-full text-sm"/>
        ...
        <div>
            ...
            <input id="slug" type="text" value={slug} readOnly className="border border-zinc-800 rounded-lg px-3 py-2 bg-zinc-800/50 w-full"/>
        </div>
